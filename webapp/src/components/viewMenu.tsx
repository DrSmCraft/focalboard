...
const ViewMenu = (props: Props) => {
    ...
    const handleDuplicateView = useCallback(() => {
        ...
        TelemetryClient.trackEvent(TelemetryCategory, TelemetryActions.DuplicateBoardView, {
            board: board.id,
            view: activeView.id
        });
    ...
    const handleDeleteView = useCallback(() => {
        ...
        TelemetryClient.trackEvent(TelemetryCategory, TelemetryActions.DeleteBoardView, {
            board: board.id,
            view: activeView.id
        });
    ...
    const handleAddViewBoard = useCallback(() => {
        ...
        TelemetryClient.trackEvent(TelemetryCategory, TelemetryActions.CreateBoardView, {
            board: board.id,
            view: activeView.id
        });
    ...
    const handleAddViewTree = useCallback(() => {
        const { board, activeView, intl } = props;

        Utils.log("addview-tree");
        ...
        const view = createBoardView();
        view.title = intl.formatMessage({ id: "View.NewTreeTitle", defaultMessage: "Tree view" });
        view.fields.viewType = "tree";
        view.parentId = board.id;
        view.boardId = board.id;
        view.fields.visiblePropertyIds = [Constants.titleColumnId];
